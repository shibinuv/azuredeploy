USE [CARSDEV]
GO
/****** Object:  StoredProcedure [dbo].[USP_CUSTOMER_INSERT]    Script Date: 01.09.2020 09:14:30 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	@CUST_COUNTRY_FLG		varchar(50)		= NULL,
	@CUST_COUNTY			varchar(50)		= NULL,
    ...
    @FLG_HOURLY_ADD			bit				= 0,
    @FLG_NO_INVOICEFEE		bit				= 0,
    @FLG_BANKGIRO		bit				= 0,
    @FLG_NO_ADDITIONAL_COST		bit				= 0,
    @FLG_PRIVATE_COMP		bit				= 0,
    @FLG_NO_HISTORY_PUBLISH			bit				= 0,
	@FLG_NO_GM				bit				= 0,
	...
	@DT_CUST_WASH			datetime		= NULL,
	@DT_CUST_DEATH			datetime		= NULL,
	@CUST_ENIRO_ID			varchar(50)		= NULL,
	@CUST_COMPANY_DESCRIPTION varchar(100)	= NULL,
	@CUST_COMPANY_NO		varchar(50)		= NULL,
	@CUST_SALESMAN			varchar(50)		= NULL,
	@CUST_SALESMAN_JOB			varchar(50)		= NULL,
	@SALES_GROUP			varchar(50)		= NULL,
	@CURRENCY_CODE			varchar(50)		= NULL,
	@INVOICE_LEVEL			varchar(50)		= NULL,
	@HOURLY_PRICE_NO			varchar(50)		= NULL,
	@PAYMENT_CARD_TYPE			varchar(50)		= NULL,
	@DEBITOR_GROUP			varchar(50)		= NULL,
...
BEGIN
	INSERT INTO [dbo].[TBL_MAS_CUSTOMER]
				...
				,[FLG_NO_INVOICEFEE]
				,[FLG_BANKGIRO]
				,[FLG_NO_ADDITIONAL_COST]
				,[FLG_PRIVATE_COMP]
				,[FLG_NO_HISTORY_PUBLISH]
				,[FLG_NO_GM]
				,[FLG_NO_ENV_FEE]
				,[FLG_PROSPECT]
				,[CUST_NOTES]
...
BEGIN
	...
	SET
		...
		[FLG_HOURLY_ADD] =  @FLG_HOURLY_ADD,
		[FLG_NO_INVOICEFEE] =  @FLG_NO_INVOICEFEE,
		[FLG_BANKGIRO] =  @FLG_BANKGIRO,
		[FLG_NO_ADDITIONAL_COST] =  @FLG_NO_ADDITIONAL_COST,
		[FLG_PRIVATE_COMP] =  @FLG_PRIVATE_COMP,
		[FLG_NO_HISTORY_PUBLISH] =  @FLG_NO_HISTORY_PUBLISH,
		[FLG_NO_GM] = @FLG_NO_GM,
		...
		[CUST_COUNTRY_FLG]	= @CUST_COUNTRY_FLG,
		[DT_CUST_WASH]	 = @DT_CUST_WASH,
		[DT_CUST_DEATH] = @DT_CUST_DEATH,
		CUST_SALESMAN = @CUST_SALESMAN,
		CUST_SALESMAN_JOB = @CUST_SALESMAN_JOB,
		SALES_GROUP = @SALES_GROUP,
		CURRENCY_CODE = @CURRENCY_CODE,
		INVOICE_LEVEL = @INVOICE_LEVEL,
		HOURLY_PRICE_NO = @HOURLY_PRICE_NO,
		PAYMENT_CARD_TYPE = @PAYMENT_CARD_TYPE,
		DEBITOR_GROUP	 = @DEBITOR_GROUP
	WHERE 
		ID_CUSTOMER = @ID_CUSTOMER
	SET @RETVAL = 'UPDFLG'
	END
