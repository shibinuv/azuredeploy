GO
/****** Object:  StoredProcedure [dbo].[USP_ITEM_FETCH]    Script Date: 26/10/2016 08:12:52 AM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'ALT_LOCATION'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD ALT_LOCATION VARCHAR(50)
END

IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'ANNOTATION'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD ANNOTATION VARCHAR(150)
END
...
IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'FLG_VAT_INCL'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD FLG_VAT_INCL BIT
END

IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'FLG_OBTAIN_SPARE'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD FLG_OBTAIN_SPARE BIT
END

IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'FLG_OBSOLETE_SPARE'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD FLG_OBSOLETE_SPARE BIT
END

IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'FLG_AUTOADJUST_PRICE'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD FLG_AUTOADJUST_PRICE BIT
END

IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'FLG_LABELS'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD FLG_LABELS BIT
...
IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'FLG_ALLOW_DISCOUNT'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD FLG_ALLOW_DISCOUNT BIT
END
...
IF NOT EXISTS(
    SELECT *
    FROM sys.columns 
    WHERE Name      = N'LAST_COST_PRICE'
      AND Object_ID = Object_ID(N'TBL_MAS_ITEM_MASTER'))
BEGIN
    ALTER TABLE dbo.TBL_MAS_ITEM_MASTER
	ADD LAST_COST_PRICE DECIMAL(20,2)
END

IF NOT EXISTS (
	SELECT * 
	FROM sys.objects 
	WHERE type = 'P' AND name = 'USP_ITEM_FETCH'
	)
	BEGIN
		EXEC('CREATE PROCEDURE [dbo].[USP_ITEM_FETCH] 
			  AS 
			  BEGIN 
				  SET NOCOUNT ON; 
			  END'
