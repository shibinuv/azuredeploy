USE [CARSDEV]
GO
/****** Object:  StoredProcedure [dbo].[USP_FETCH_CUSTOMER_DETAILS]    Script Date: 01.09.2020 09:33:47 ******/
SET ANSI_NULLS ON
GO
...
CUST_PHONE_OFF,		
CUST_PHONE_HOME,		
(select CONTACT_VALUE from TBL_MAS_CUSTOMER_CONTACT where CONTACT_TYPE=1 and CONTACT_STANDARD=1 and CONTACT_CUSTOMER_ID = @ID_CUST) AS CUST_PHONE_MOBILE,	
CUST_FAX,			
CUST_ID_EMAIL,		
CUST_REMARKS,		
CUST_PERM_ADD1,		
