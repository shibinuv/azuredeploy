<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmSalesPerMechanic.aspx.vb" Inherits="CARS.frmSalesPerMechanic" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cntMainPanel" runat="Server">
    <script type="text/javascript">
        ...
        function fnValidate() {
            ...
            if ($("#<%=ddlDeptFrom.ClientID%> option:selected").text() > $("#<%=ddlDeptTo.ClientID%> option:selected").text()) {
        ...
        function printReport() {
            ...
            if (validate == true) {
                ...
                $.ajax({
                    ...
                    url: "frmSalesPerMechanic.aspx/LoadReport",
                    data: "{'deptFrom':'" + deptFrom + "','deptTo':'" + deptTo + "','year':'" + year + "','fromMnth':'" + fromMnth + "','toMnth':'" + toMnth + "','fromMecCode':'" + fromMecCode + "','toMecCode':'" + toMecCode + "'}",
                    dataType: "json",
                    ...
                    success: function (Result) {
                        if (Result.d.length > 0) {
                            ...
                            $('#<%=RTlblError.ClientID%>').text("Ingen poster ble funnet!");
                        }
                    }
                });
            }
     ...
     <asp:Label ID="lblHeader" runat="server" Text="Sales Per Mechanic"></asp:Label>
