<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCreditNoteSalesJournal.aspx.vb" Inherits="CARS.frmCreditNoteSalesJournal" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cntMainPanel" runat="Server">
        ...
        function printReport() {
            ...
            if (fnChkvalidation()) {
                $.ajax({
                    ...
                    url: "frmCreditNoteSalesJournal.aspx/LoadReport",
    ...
    <div class="header1" style="padding-top:0.5em">
         <asp:Label ID="lblHeader" runat="server" Text="Credit Note Sales Journal"></asp:Label>
