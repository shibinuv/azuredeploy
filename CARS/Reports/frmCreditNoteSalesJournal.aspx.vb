...
Public Class frmCreditNoteSalesJournal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Reports_frmCreditNoteSalesJournal", "Page_Load", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
    End Sub

    Public Sub Fetch_DepartmentList()
        Try
            ...
            End If
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Reports_frmCreditNoteSalesJournal", "Fetch_DepartmentList()", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, Session("UserId"))
        End Try
    End Sub
    Public Sub Load_Customer_ID()
        ...
        Catch exth As System.Threading.ThreadAbortException
            Throw exth
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Reports_frmCreditNoteSalesJournal", "Load_Customer_ID", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, Session("UserId"))
            Throw ex
        End Try
    End Sub
    Public Sub Load_Payment_Type()
        ...
        Catch exth As System.Threading.ThreadAbortException
            Throw exth
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Reports_frmCreditNoteSalesJournal", "Load_Payment_Type", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, Session("UserId"))
            Throw ex
        End Try
    End Sub
    <WebMethod()> _
    Public Shared Function LoadReport(ByVal deptFrom As String, ByVal deptTo As String, ByVal fromDate As String, ByVal toDate As String, ByVal custIdFrom As String, ByVal custIdTo As String, ByVal payTypeFrom As String, ByVal payTypeTo As String, ByVal flgJournal As String, ByVal flgDI As String, ByVal flgDP As String) As String
        ...
        Dim CNSalesJournalXML As String = String.Empty
        Try
            If toDate <> "" Then
            ...
            CNSalesJournalXML += "<ROOT> <Parameters " _
            ...
            HttpContext.Current.Session("CNSalesJournalXML") = CNSalesJournalXML
            'If (dsReturnVal.Tables(0).Rows.Count > 0) Then
            If flgJournal = True Then
                reportRequest = "../Reports/frmShowReports.aspx?ReportHeader=" + objCommonUtil.fnEncryptQString("CNSalesJournal") + "&Rpt=" + objCommonUtil.fnEncryptQString("CNSalesJournal") + "&scrid=" + rnd.Next().ToString()

            ElseIf flgDI = True Then
                reportRequest = "../Reports/frmShowReports.aspx?ReportHeader=" + objCommonUtil.fnEncryptQString("CNSalesJournalDI") + "&Rpt=" + objCommonUtil.fnEncryptQString("CNSalesJournalDI") + "&scrid=" + rnd.Next().ToString()

            ElseIf flgDP = True Then
                reportRequest = "../Reports/frmShowReports.aspx?ReportHeader=" + objCommonUtil.fnEncryptQString("CNSalesJournalDP") + "&Rpt=" + objCommonUtil.fnEncryptQString("CNSalesJournalDP") + "&scrid=" + rnd.Next().ToString()
            End If

            'End If
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Reports_frmCreditNoteSalesJournal", "LoadReport", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
