...
Public Class rptTimeRegCTMech
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CARS.rptTimeRegCTMech.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTimeRegCTMech
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTimeRegCTMech = New rptTimeRegCTMech()
        rpt.Site = Me.Site
        Return rpt
    End Function
