...
Public Class WorkOrderSpares
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CARS.WorkOrderSpares.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWorkOrderSpares
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WorkOrderSpares = New WorkOrderSpares()
        rpt.Site = Me.Site
        Return rpt
    End Function
