...
Public Class SparePartImportTemplate
    ...
    Private Sub GetDefaultValue(ByVal ddl As DropDownList, ByVal Text As String, ByVal Value As String, ByVal IndexValue As String)
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_SparePartImportTemplate", "GetDefaultValue", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, Session("UserID"))
            Throw ex
        End Try
    End Sub
    <WebMethod()> _
    Public Shared Function loadControls(ByVal fileType As String, ByVal fileName As String, ByVal templateId As String) As CustomerExportBO()
        Try
            ...
            details = objCusExpSvc.FetchSpareTemplateConfigEdit(objCusExpBO)

        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_SparePartImportTemplate", "LoadImportListGrd", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return details.ToList.ToArray()
    End Function
    <WebMethod()> _
    Public Shared Function BindImportConfig(ByVal fileType As String, ByVal fileName As String, ByVal templateId As String) As CustomerExportBO()
        Try
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_SparePartImportTemplate", "BindExportConfig", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return details.ToList.ToArray()
    End Function
    <WebMethod()> _
    Public Shared Function SaveSpareTemplateConfig(ByVal fileType As String, ByVal fileName As String, ByVal templateId As String, ByVal importTypeName As String, ByVal charSet As String, ByVal decimalDelim As String, ByVal thouDelim As String, _
             ByVal dateFormat As String, ByVal timeFormat As String, ByVal fileMode As String, ByVal otherDelimiter As String, ByVal desc As String, ByVal Configuration As String, ByVal splDelimiter As String, ByVal ordSeriesLen As String, ByVal ordPrLen As String, ByVal jobIdLen As String) As String
        ...
        Try
            ...
            objCusExpBO.PrefixLen = ordPrLen
            objCusExpBO.SeriesLen = ordSeriesLen
            objCusExpBO.JobIdLen = jobIdLen
            strRetVal = objCusExpSvc.SaveSpareConfiguration(objCusExpBO)
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_SparePartImportTemplate", "LoadImportListGrd", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return strRetVal
    End Function
    <WebMethod()> _
    Public Shared Function DeleteImportConfig(ByVal FileType As String, ByVal fileName As String, ByVal templateId As String) As String
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_SparePartImportTemplate", "DeleteExportConfig", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return strVal
    End Function
End Class