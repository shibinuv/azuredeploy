<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CustomerExport.aspx.vb" Inherits="CARS.CustomerExport" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cntMainPanel" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function loadImportListGrid() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "CustomerExport.aspx/LoadImportListGrd",
        ...
        function loadAllControls(fileType, fileName, templateId)
        {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "CustomerExport.aspx/loadControls",
        ...
        function loadExportConfigGrid(fileType,fileName,templateId)
        {
            ...
            grid.jqGrid({
                datatype: "local",
                data: mydata,
                colNames: ['FieldName','PostionFrom','FieldLength', 'OrderInFile', 'DecimalDivide', 'FixedInformation','EnclosingCharacter','FieldId'],
                colModel: [
                         ...
                         { name: 'DecimalDivide', index: 'DecimalDivide', width: 120, sorttype: "string", hidden: true },
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "CustomerExport.aspx/BindExportConfig",
                data: "{'fileType':'" + fileType + "','fileName':'" + fileName + "','templateId':'" + templateId + "'}",
                dataType: "json",
                async: false,//Very important
                success: function (data) {
            ...
            if ($('#<%=hdnFileMode.ClientID%>').val() == "FIXED")
            {
                var colPos = 2;
                var myGrid = $('#dgdExportConfiguration');
                myGrid.jqGrid('showCol', myGrid.getGridParam("colModel")[colPos].name);
            ...
            else if ($('#<%=hdnFileMode.ClientID%>').val() == "DELIMITER")
            {
                var colPos = 2;
                var myGrid = $('#dgdExportConfiguration');
                myGrid.jqGrid('showCol', myGrid.getGridParam("colModel")[colPos].name);
        ...
        function SaveExportConfiguration()
        {
            ...
            if (bool == true) {
                ...
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "CustomerExport.aspx/SaveExpConfig",
            ...
            $('#dgdImportList input:checkbox').attr("checked", function () {
                if (this.checked) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "CustomerExport.aspx/DeleteExportConfig",
   ...
   <%-- <table id="jqGrid"></table>
    <div id="jqGridPager"></div>--%>
     ...
     <asp:Label ID="lblHeader" runat="server" Text="Customer Export"></asp:Label>
