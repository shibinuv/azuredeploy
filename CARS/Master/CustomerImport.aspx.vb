...
Public Class CustomerImport
    ...
    Private Sub GetDefaultValue(ByVal ddl As DropDownList, ByVal Text As String, ByVal Value As String, ByVal IndexValue As String)
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_CustomerImport", "GetDefaultValue", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, Session("UserID"))
            Throw ex
        End Try
    End Sub
    <WebMethod()> _
    Public Shared Function LoadImportListGrd(ByVal fileType As String, ByVal fileName As String) As CustomerExportBO()
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_CustomerImport", "LoadImportListGrd", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
    ...
    Public Shared Function loadControls(ByVal fileType As String, ByVal fileName As String, ByVal templateId As String) As CustomerExportBO()
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_CustomerBalanceImport", "LoadImportListGrd", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return details.ToList.ToArray()
    End Function
    <WebMethod()> _
    Public Shared Function loadCharSetControls(ByVal CharSet As String) As CustomerExportBO()
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_CustomerBalanceImport", "loadCharSetControls", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return details.ToList.ToArray()
    End Function
    <WebMethod()> _
    Public Shared Function BindImportConfig(ByVal fileType As String, ByVal fileName As String, ByVal templateId As String) As CustomerExportBO()
        ...
        Catch ex As Exception
            objErrHandle.WriteErrorLog(1, "Master_CustomerBalanceImport", "BindExportConfig", ex.Message, ex.GetBaseException.StackTrace.ToString.Trim, loginName)
        End Try
        Return details.ToList.ToArray()
    End Function
    <WebMethod()> _
    Public Shared Function SaveImportConfig(ByVal fileType As String, ByVal fileName As String, ByVal templateId As String, ByVal importTypeName As String, ByVal charSet As String, ByVal decimalDelim As String, ByVal thouDelim As String, _
