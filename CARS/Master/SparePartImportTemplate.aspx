<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SparePartImportTemplate.aspx.vb" Inherits="CARS.SparePartImportTemplate" MasterPageFile="~/MasterPage.Master" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=btnAdd1.ClientID%>').click(function () {
                ...
                $('#<%=txtOrdPrLen.ClientID%>').val("3");
                $('#<%=txtOrdSeries.ClientID%>').val("5");
                $('#<%=txtJobIdLen.ClientID%>').val("2");
        ...
        function loadAllControls(fileType, fileName, templateId) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "SparePartImportTemplate.aspx/loadControls",
                ...
                success: function (data) {
                    ...
                    $('#<%=txtOrdPrLen.ClientID%>').val(data[0].PrefixLen);
                    $('#<%=txtOrdSeries.ClientID%>').val(data[0].SeriesLen);
                    $('#<%=txtJobIdLen.ClientID%>').val(data[0].JobIdLen);
                }
            });
        }
        ...
        function loadImportConfigGrid(fileType, fileName, templateId) {
            ...
            grid.jqGrid({
                ...
                colModel: [
                         ...
                         { name: 'FieldName', index: 'FieldName', width: 390},
                         { name: 'PositionFrom', index: 'PositionFrom', width: 120, editable: true, editrules: { custom: true, custom_func: ValidateNumber } },
                         { name: 'Length', index: 'Length', width: 120, editable: true, editrules: { custom: true, custom_func: ValidateNumber } },
                         { name: 'OrderInFile', index: 'OrderInFile', width: 120, editable: true, editrules: { custom: true, custom_func: ValidateNumber } },
                         { name: 'DecimalDivide', index: 'DecimalDivide', width: 120 },
                         { name: 'FixedInformation', index: 'FixedInformation', width: 120,  editable: true, editrules: { custom: true, custom_func: ValidateAlphabets } },
                          { name: 'FieldId', index: 'FieldId', width: 390, sorttype: "string", hidden: true },
                           { name: 'IsDecimalDivide', index: 'IsDecimalDivide', width: 20,  hidden: true },
                ...
                autoWidth: true,
                shrinkToFit: true,
                caption: "Spare Part Import List",
                async: false, //Very important,
                subgrid: false,
                'cellEdit': true,
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "SparePartImportTemplate.aspx/BindImportConfig",
                data: "{'fileType':'" + fileType + "','fileName':'" + fileName + "','templateId':'" + templateId + "'}",
                dataType: "json",
                async: false,//Very important
                success: function (data) {
                    ...
                    else if (data.d[0].FileMode == "DELIMITER") {
                        for (i = 1; i < data.d.length; i++) {
                            mydata = data;
                            jQuery("#dgdImportConfiguration").jqGrid('addRowData', i + 1, mydata.d[i]);
                        }
        ...
        function SaveImportConfiguration() {
            ...
            if (bool == true) {
                ...
                for (var i = 0; i < rowData.length; i++) {
                    ...
                    var ordSeriesLen = $('#<%=txtOrdSeries.ClientID%>').val();
                    var ordPrLen = $('#<%=txtOrdPrLen.ClientID%>').val();
                    var jobIdLen = $('#<%=txtJobIdLen.ClientID%>').val();
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "SparePartImportTemplate.aspx/SaveSpareTemplateConfig",
                    data: "{'fileType':'" + fileType + "','fileName':'" + fileName + "','templateId':'" + templateId + "','importTypeName':'" + importTypeName + "','charSet':'" + charSet + "','decimalDelim':'" + decimalDelim + "','thouDelim':'" + thouDelim +
                        "','dateFormat':'" + dateFormat + "','timeFormat':'" + timeFormat + "','fileMode':'" + fileMode + "','otherDelimiter':'" + otherDelimiter + "','desc':'" + desc + "','Configuration':'" + StrIntXMLs + "','splDelimiter':'" + splDelimiter + "','ordSeriesLen':'" + ordSeriesLen + "','ordPrLen':'" + ordPrLen + "','jobIdLen':'" + jobIdLen + "'}",
                    dataType: "json",
                    async: false,//Very important
                    success: function (data) {
                        data = data.d
            ...
            $('#dgdImportList input:checkbox').attr("checked", function () {
                if (this.checked) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "SparePartImportTemplate.aspx/DeleteImportConfig",
...
<div class="header1" style="padding-top:0.5em">
     <asp:Label ID="lblHeader" runat="server" Text="Spare Part Import"></asp:Label>
    ...
    <div id="divCfInvDetails" class="ui raised segment signup inactive">
         <div class="six fields">
             <div style="text-align:center">
                <input id="btnAdd1" runat="server" class="ui button"  value="Add" type="button"   />
                 <input id="btnDelete1" runat="server" class="ui button" value="Delete" type="button" onclick="deleteSPConfig()" />
            </div>
         </div>
         ...
         <div class="six fields">
             <div style="text-align:center">
                <input id="btnAdd2" runat="server" class="ui button"  value="Add" type="button"   />
                 <input id="btnDelete2" runat="server" class="ui button" value="Delete" type="button" onclick="deleteSPConfig()" />
            </div>
         </div>
         <div id="divControls">
        <div class="ui secondary vertical menu" style="width: 100%; background-color: #c9d7f1">
         ...
         <div class="six fields" style="border-color:#e5e5e5;border-style: solid;border-width: 1px;height:31px">
             ...
             <asp:Label ID="lblExportType" runat="server" Text="Import Type Name" Width="180px"></asp:Label>
         ...
         <div id="divExpGrid">
        <div class="ui secondary vertical menu" style="width: 100%; background-color: #c9d7f1">
                        <a id="A2" runat="server" class="active item">Order Series </a>  
         </div>
        <div id="OrdSeries">
         <div class="four fields" style="border-color:#e5e5e5;border-style: solid;border-width: 1px;height:31px">
           <div class="field" style="padding:0.55em;height:40px">
              <asp:Label ID="lblOrdPrLen" runat="server" Text="Order Prefix Length " Width="180px"></asp:Label>
              <asp:TextBox ID="txtOrdPrLen" runat="server" Width="30px"></asp:TextBox>                  
           </div>
        </div>
         <div class="four fields" style="border-color:#e5e5e5;border-style: solid;border-width: 1px;height:31px">
           <div class="field" style="padding:0.55em;height:40px">
              <asp:Label ID="lblOrdSeries" runat="server" Text="Order Series Length " Width="180px"></asp:Label>
              <asp:TextBox ID="txtOrdSeries" runat="server" Width="30px"></asp:TextBox>                  
           </div>
        </div>
        <div class="four fields" style="border-color:#e5e5e5;border-style: solid;border-width: 1px;height:31px">
           <div class="field" style="padding:0.55em;height:40px">
              <asp:Label ID="lblJobIdLen" runat="server" Text="JobId Length " Width="180px"></asp:Label>
              <asp:TextBox ID="txtJobIdLen" runat="server" Width="30px"></asp:TextBox>                  
           </div>
        </div>
    </div>
    <div class="ui secondary vertical menu" style="width: 100%; background-color: #c9d7f1">
